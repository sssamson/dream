      ...
      <div class="row">
        <div class="col-md-4">
          ...
          <div class="widget clearfix widget-contact-us" style="background-image: url('images/world-map-dark.png'); background-position: 50% 20px; background-repeat: no-repeat">
            <h4>About HAMULTI</h4>
            <ul class="list-icon">
              <li><i class="fa fa-map-marker"></i> 195 14th St NE
                <br>Atlanta, GA 30309
              </li>
              <li><i class="fa fa-phone"></i> (321) 426.8584 </li>
              <li><i class="fa fa-envelope"></i> <a href="mailto:info@hamulti.com">info@hamulti.com</a>
              </li>
              <li>
