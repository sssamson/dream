...
<body>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12 text-center">
                        <h2><span class="section-title-style left-section-title-style"><i></i><i></i><i></i></span><b> <?= $page['title'] ?> </b><span class="section-title-style right-section-title-style"><i></i><i></i><i></i></span></h2>
                    </div>
                </div>
            </div>
        </div>
    ...
    <!-- CONTACT FORM JS -->
    <script src="/assets/front/js/form-contact.js"></script>
    <!-- SCRIPT JS -->
